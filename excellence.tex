...
\subsubsection{Individual Doctoral Candidate (DC) research projects}
\note{Describe each DC's individual research project, including for each a title, objectives, expected results, and planned secondments (purpose, timing, duration, host, sector). Explain how those projects will be integrated into --- and contribute to --- the overall research programme and objectives.}
...
models and assumptions that underpin your work. Explain how this will enable you to deliver your project’s objectives.}
...
\begin{msctable}{|>{\ra}p{10mm}|>{\ra}p{70mm}|>{\ra}p{25mm}|>{\ra}p{25mm}|>{\ra}p{25mm}|}
    \colorrow
    \hline &
