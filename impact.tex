...
\note{In this section, please explain the impact of the research and training on the fellows' careers prospects. Explain how the project and the training will give technical and transferable skills to the fellows, which will improve their employability in academia and/or the industry. Explain the specific measures taken by the project to enhance the career perspectives of the DCs, i.e. to support them in exploring a wide range of career options in terms of topics, disciplines, professional environments or sectors.}
...
\note{Concrete plans for sections 2.3 must be included in the corresponding table 3.1a Description of Work Packages.}
